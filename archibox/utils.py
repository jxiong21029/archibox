...
def parse_config_overrides(main: Callable):
    ...
    try:
        ...
        raise ValueError(f"failed to initialize default config: {e}") from e
    ...
    for override in args.overrides:
        ...
        *prefix, final_key = key.split(".")
        ...
        try:
            ...
            raise TypeError(f"failed to cast {value_str} to type {target_type}: {e}")
